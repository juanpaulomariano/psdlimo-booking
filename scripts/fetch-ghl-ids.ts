...
async function main() {
  ...
  const config = {
    ...
    tags: {
      ...
      rideAirport: "ride.airport",
      rideHourly: "ride.hourly",
      rideIntercity: "ride.intercity",
      rideWinetour: "ride.winetour",
      rideGroup: "ride.group",
      rideCorporate: "ride.corporate",
      ridePointToPoint: "ride.pointtopoint",
